...
public class AuthAPI {
    ...
    private Call<AuthResponse> authenticate() {
        // other api endpoints are different
        ...
        // Assemble request data // change to Bearer + auth
    ...
    public interface AuthCallback {
        void onAuth(edu.ranken.david_jenn.game_library.data.AuthAPI.AuthResponse authResponse);
    }

    public interface AuthFailureCallback {
        void onAuthFailure(edu.ranken.david_jenn.game_library.data.AuthAPI.AuthException ex);
    }
